...
//////this class contains sample plants diseases that can affect plants. It was provided image samples fed to the model//////
...
//////the result of the plant disease detection is returned in the code below//////
//////the disease is shown in an alert dialog and it also returns healthy for healthy plants//////

 Widget build(BuildContext context) {
    return AlertDialog(
     
    
            content: Text(disease[diseaseName],
            style: TextStyle(
                        fontFamily: 'Futura',
